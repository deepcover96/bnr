...
class WidgetsControllerTest < ActionController::TestCase
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post :create, widget: { color: @widget.color, description: @widget.description, name: @widget.name, size: @widget.size }
    end
  ...
  test "should update widget" do
    put :update, id: @widget, widget: { color: @widget.color, description: @widget.description, name: @widget.name, size: @widget.size }
    assert_redirected_to widget_path(assigns(:widget))
  end
